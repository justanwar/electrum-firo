...
from electrum_firo.base_wizard import (BaseWizard, HWD_SETUP_DECRYPT_WALLET,
...
WIF_HELP_TEXT = (_('WIF keys are typed in Firo Electrum, based on script type.') + '\n\n' +
                 _('A few examples') + ':\n' +
...
MSG_PASSPHRASE_WARN_ISSUE4566 = _("Warning") + ": "\
                              ...
                              + _("Due to a bug, old versions of Firo Electrum will NOT be creating the "
...
class InstallWizard(QDialog, MessageBoxMixin, BaseWizard):
    ...
    def select_storage(self, path, get_wallet_from_daemon) -> Tuple[str, Optional[WalletStorage]]:
        ...
        self.set_layout(vbox, title=_('Firo Electrum wallet'))
    ...
    def run_upgrades(self, storage: WalletStorage, db: 'WalletDB') -> None:
        ...
        if db.requires_split():
            self.hide()
            msg = _("The wallet '{}' contains multiple accounts, which are no longer supported since Firo Electrum 2.7.\n\n"
    ...
    def init_network(self, network: 'Network'):
        message = _("Firo Electrum communicates with remote servers to get "
                  "information about your transactions and addresses. The "
                  "servers all fulfill the same purpose only differing in "
                  "hardware. In most cases you simply want to let Firo Electrum "
